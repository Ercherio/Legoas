...
var connectionString = builder.Configuration.GetConnectionString("LegoasContext");
builder.Services.AddDbContext<MyContext>(options => options.UseSqlServer(connectionString));

builder.Services.AddScoped<AccountRepository>();
builder.Services.AddScoped<AccountRoleRepository>();
builder.Services.AddScoped<AccountOfficeRepository>();
...
builder.Services.AddSwaggerGen(x =>
{
    ...
    {
        Version = "v1",
        Title = "API Project Web Organization",
