...
public class OfficesController : BaseController<int, Office, DepartmentRepository>
{
    private readonly DepartmentRepository repository;

    public OfficesController(DepartmentRepository repository) : base(repository)
    {
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var department = new List<Office>();
